...
function ComputerPage(props) {
    ...
    const handleRegisterSubmitCilck = async () => {
        try {
            const resp = await axios.post("http://localhost:8080/api/v1/computer", registerComputer);
    ...
    return (
        <div>
            ...
            <div css={layout}>
                ...
                <p>
                    <button onClick={handleRegisterSubmitCilck}>등록하기</button>
                </p>
            </div>
